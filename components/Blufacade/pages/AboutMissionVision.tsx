...
const CARDS = [
  {
    ...
    title: "Who We Are",
    description:
      "Welcome to Rayzor Industrial Packaging Pvt Ltd, where expertise meets innovation. For over two decades, we've been the driving force behind tailor-made packaging solutions. Our production hub in Madurai, Tamil Nadu, India, stands as a testament to our commitment to precision and quality.",
    bgColor: "bg-[#111827]", // Deep Charcoal
    bgImage: "/images/about-mission-vision/card_bg_dark.jpg",
  },
  {
    ...
    description:
      "Specializing in VCI Film Rolls, VCI Pouch, VCI Bags, VCI Sheet, LDPE Film Rolls, LDPE Pouch, LDPE Bags, LDPE Sheet, Pallet Covers and Container Liner bags, we cater to diverse industries, ensuring your products receive packaging that not only protects but enhances their value.",
    bgColor: "bg-[#6b7280]", // Neutral Grey
    bgImage: "/images/about-mission-vision/card_bg_grey.jpg",
  },
  {
    ...
    description:
      "Our in-house production, coupled with strict quality standards, certifications, and reliable suppliers, ensures flexibility and reliability. Whether on the phone or on-site, our dedicated team collaborates with you, providing fast and optimal solutions for your packaging needs.",
    bgColor: "bg-[var(--brand-blue)]", // Brand blue
    bgImage: "/images/about-mission-vision/card_bg_orange.jpg",
  },
];
...
export function AboutMissionVision() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-white py-20 lg:py-32 font-sans overflow-hidden"
    >
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 xl:px-12">
        ...
        <div className="mb-12">
          <h2 className="text-4xl md:text-5xl font-heading font-extrabold tracking-tight whitespace-nowrap">
            <span className="text-[var(--brand-dark)]">Our Mission & </span>
            <span className="text-[var(--brand-blue)]">Vision</span>
          </h2>
        </div>
